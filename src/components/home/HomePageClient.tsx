...
export default function HomePageClient({ dataByLocale, defaultLocale }: HomePageClientProps) {
  ...
  return (
    <div className="portfolio-hero mx-auto min-h-[calc(100vh-7rem)] max-w-[76rem] px-5 py-7 sm:px-9 sm:py-11 lg:px-12 lg:py-14">
      ...
      <div className="relative grid grid-cols-1 items-center gap-6 sm:gap-9 lg:grid-cols-[minmax(0,1.12fr)_minmax(19rem,0.88fr)] lg:gap-9 xl:gap-14">
        ...
        <div className="order-2 min-w-0 space-y-8 sm:space-y-10 lg:order-1 lg:py-8">
